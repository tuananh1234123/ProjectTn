...
<link href="<c:url value='/template/web/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css'/>" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css"
...
<link rel="stylesheet" type="text/css"
	href="
<c:url value='/template/web/styles/responsive.css'/>
">
<
...
<body>
	...
	"></script>
	<script src="<c:url value='/template/web/styles/bootstrap4/popper.js'/>
	"></script>
	<script src="<c:url value='/template/web/styles/bootstrap4/bootstrap.min.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/greensock/TweenMax.min.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/greensock/TimelineMax.min.js'/>
	"></script>

	<script src="<c:url value='/template/web/plugins/scrollmagic/ScrollMagic.min.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/greensock/animation.gsap.min.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/greensock/ScrollToPlugin.min.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/OwlCarousel2-2.2.1/owl.carousel.js'/>
	"></script>
	<script src="<c:url value='/template/web/plugins/slick-1.8.0/slick.js'/>
	"></script>
