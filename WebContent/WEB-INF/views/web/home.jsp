				...
				<div class="col">
					...
					<div class="reviews_slider_container">
						...
						<div class="owl-carousel owl-theme reviews_slider">
							...
							<!-- Reviews Slider Item -->
							<c:forEach items="${od}" var="sanpham">
								<div class="owl-item">
									<div
...
alt="">
										...
										<div class="review_content">
											<div class="review_name">${sanpham.orderID}</div>
											...
											<div class="review_text">Giá sản phẩm: ${sanpham.customerID}</div>
											<div class="review_text">Mô tả:<br>${sanpham.staffID}</div>
											<div class="review_text">Số lượng trong kho: ${sanpham.orderDate}</div>
											<div class="review_text">Số lượng trong kho: ${sanpham.shipperID}</div>
											<div class="review_text">Số lượng trong kho: ${sanpham.description}</div>
										</div>
									</div>
								</div>
							</c:forEach>
