		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li
							data-image="<c:url value='/template/web/images/single_4.jpg'/>"><img
							src="<c:url value='/template/web/images/single_4.jpg'/>" alt=""></li>
						<li
							data-image="<c:url value='/template/web/images/single_2.jpg'/>"><img
							src="<c:url value='/template/web/images/single_2.jpg'/>" alt=""></li>
						<li
							data-image="<c:url value='/template/web/images/single_3.jpg'/>"><img
							src="<c:url value='/template/web/images/single_3.jpg'/>" alt=""></li>
					</ul>
				</div>
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected">
						<img src="<c:url value='/template/web/images/single_4.jpg'/>"
							alt="">
					</div>
				</div>
							...
							<form action="#">
								<div class="clearfix" style="z-index: 1000;">
									...
									<div class="product_quantity clearfix">
										<span>Quantity: </span> <input id="quantity_input" type="text"
											pattern="[0-9]*" value="1">
